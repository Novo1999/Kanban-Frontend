...
export type User = { name: string; email: string; avatarUrl: string; _id: string; __v?: number }
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 bg-primary focus:ring-blue-500 focus:border-transparent outline-none transition-colors"
                  autoFocus
                />
              </div>
            </div>
